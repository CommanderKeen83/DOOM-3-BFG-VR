...
idCVar vr_twoHandedGripDistance( "vr_twoHandedGripDistance", "1.5", CVAR_FLOAT | CVAR_ARCHIVE | CVAR_GAME, "Distance in inches to engage two-handed grip (approx 3.8 cm)." );
idCVar vr_twoHandedReleaseDistance( "vr_twoHandedReleaseDistance", "3.5", CVAR_FLOAT | CVAR_ARCHIVE | CVAR_GAME, "Distance in inches to release two-handed grip (approx 8.9 cm)." );
